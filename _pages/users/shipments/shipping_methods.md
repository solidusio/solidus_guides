...
![New Shipping Method]({{ site.baseurl }}/assets/img/users/shipments/new_shipping_method.jpg)
...
You can optionally input a tracking URL for your new shipping method. This allows customers to track the progress of their package from your [Stock Location]({{ site.baseurl }}/users/stock/stock_locations) to the order's shipping address. The string ":tracking" will be replaced with the tracking number you input once you actually process the order.
...
!!!
Please note that Solidus Commerce, Inc. makes no claims of warranty or accuracy for the information presented on third-party websites. We strongly urge you to verify the information independently before you put it into production on your store.
!!!
...
![Shipping Method Categories]({{ site.baseurl }}/assets/img/users/shipments/shipping_method_categories.jpg)
...
![Shipping Method Zones]({{ site.baseurl }}/assets/img/users/shipments/shipping_method_zones.jpg)

Check the boxes next to any zones you want served by this shipping method.

#### Calculator

Each shipping method is associated with one [Calculator](../calculators). You can choose one of the built-in Solidus calculators, or one you made yourself.

![Shipping Method Calculator]({{ site.baseurl }}/assets/img/users/shipments/shipping_method_calculator.jpg)
...
![Shipping Method Flat Percent]({{ site.baseurl }}/assets/img/users/shipments/shipping_method_flat_percent.jpg)
...
![Edit Shipping Method]({{ site.baseurl }}/assets/img/users/shipments/edit_shipping_method.jpg)
...
![Delete Shipping Method]({{ site.baseurl }}/assets/img/users/shipments/delete_shipping_method.jpg)
