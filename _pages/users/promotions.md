...
The Solidus cart's promotions functionality allows you to offer coupons and discounts to your site's users, based on the conditions you choose. This guide will explain to you all of the options at hand.
...
![New Promotion]({{ site.baseurl }}/assets/img/users/promotions/new_promotion.jpg)
...
![Rules Options]({{ site.baseurl }}/assets/img/users/promotions/rules_options.jpg)

#### Item Total

When you select "Item total" from the "Add Rule of Type" drop-down menu and click "Add", you are declaring an Item Total rule.

![Item Total Rule]({{ site.baseurl }}/assets/img/users/promotions/item_total_rule.jpg)
...
![Delete Rule Icon]({{ site.baseurl }}/assets/img/users/promotions/delete_rule_icon.jpg)
***
...
![Products Rule]({{ site.baseurl }}/assets/img/users/promotions/products_rule.jpg)
...
![User Rule]({{ site.baseurl }}/assets/img/users/promotions/user_rule.jpg)
...
![First Order Rule]({{ site.baseurl }}/assets/img/users/promotions/first_order_rule.jpg)
...
![Logged In Rule]({{ site.baseurl }}/assets/img/users/promotions/logged_in_rule.jpg)
...
When you select "Create adjustment" from the "Add Action of Type" drop-down menu and click "Add", the system presents you with several calculator options. These are the same as the options you read about in the [calculators guide](../shipments/calculators), except that instead of a [price sack calculator](calculators#price-sack), there are two additional calculators: percent per item and free shipping.

![Create Adjustments Action Calculators]({{ site.baseurl }}/assets/img/users/promotions/create_adjustment.jpg)
...
![Create Line Item Action]({{ site.baseurl }}/assets/img/users/promotions/create_line_item.jpg)
...
![Edit Promotion Icon]({{ site.baseurl }}/assets/img/users/promotions/edit_promotion_icon.jpg)

## Removing a Promotion

To remove a promotion, click the "Delete" icon next to the promotion in the Promotions list.

![Delete Promotion Icon]({{ site.baseurl }}/assets/img/users/promotions/delete_promotion_icon.jpg)
