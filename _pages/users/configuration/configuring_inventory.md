...
![New Stock Location]({{ site.baseurl }}/assets/img/users/config/new_stock_location.jpg)
...
![Edit Stock Location Icon]({{ site.baseurl }}/assets/img/users/config/edit_stock_location_icon.jpg)
...
![Delete Stock Location Icon]({{ site.baseurl }}/assets/img/users/config/delete_stock_location_icon.jpg)
...
![Stock Movements Link]({{ site.baseurl }}/assets/img/users/config/stock_movements_link.jpg)
...
![New Stock Transfer]({{ site.baseurl }}/assets/img/users/config/new_stock_transfer.jpg)
...
![Stock Transfer Readied]({{ site.baseurl }}/assets/img/users/config/stock_transfer.jpg)
...
![Stock Transfer Complete]({{ site.baseurl }}/assets/img/users/config/stock_transfer_complete.jpg)
...
![Resulting Stock Movements]({{ site.baseurl }}/assets/img/users/config/resulting_stock_movements.jpg)