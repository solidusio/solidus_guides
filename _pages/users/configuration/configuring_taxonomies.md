...
Taxonomies are the Solidus system's approach to category trees. The heading of a tree is called a _Taxonomy_. Any child branches are called _Taxons_. Taxons themselves can have their own branches. So you could have something like the following categories structure:

![Taxonomy Tree]({{ site.baseurl }}/assets/img/users/config/taxonomy_tree.jpg)
...
![New Taxonomy]({{ site.baseurl }}/assets/img/users/config/new_taxonomy.jpg)
...
![Edit Taxonomy Icon]({{ site.baseurl }}/assets/img/users/config/edit_taxonomy_icon.jpg)
...
![Edit Taxonomy]({{ site.baseurl }}/assets/img/users/config/edit_taxonomy.jpg)

### Delete a Taxonomy

![Delete Taxonomy Icon]({{ site.baseurl }}/assets/img/users/config/delete_taxonomy_icon.jpg)
...
![Add Taxon to Taxonomy]({{ site.baseurl }}/assets/img/users/config/add_taxon_to_taxonomy.jpg)
...
![New Taxon]({{ site.baseurl }}/assets/img/users/config/new_taxon.jpg)
...
![Add Taxon to Another Taxon]({{ site.baseurl }}/assets/img/users/config/add_taxon_to_taxon.jpg)

Enter the name of the child taxon and click enter. Repeat this process for any sub-trees you need.

![Complex Taxonomy Tree]({{ site.baseurl }}/assets/img/users/config/complex_taxonomy_tree.jpg)
...
![Reordering Taxons]({{ site.baseurl }}/assets/img/users/config/reorder_taxons.jpg)

You can even drag a parent taxon into the tree of a different parent taxon, merging it into the second taxon's sub-tree.

![Parent-to-Parent Taxon Merge]({{ site.baseurl }}/assets/img/users/config/parent_into_parent_taxon_merge.jpg)

### Edit a Taxon

To edit a taxon's name, just right-click it and click "Edit".

![Edit Taxon Form]({{ site.baseurl }}/assets/img/users/config/edit_taxon.jpg)
...
![Remove a Taxon]({{ site.baseurl }}/assets/img/users/config/remove_taxon.jpg)
...
![Add Taxons to a Product]({{ site.baseurl }}/assets/img/users/config/add_taxons_to_product.jpg)