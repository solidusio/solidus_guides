...
![New Option Type]({{ site.baseurl }}/assets/img/users/products/new_option_type.jpg)
...
![New Option Value]({{ site.baseurl }}/assets/img/users/products/new_option_value.jpg)
...
![Completed Option Values]({{ site.baseurl }}/assets/img/users/products/large_small_option_values.jpg)
...
![Option Types Dropdown List]({{ site.baseurl }}/assets/img/users/products/option_types_dropdown.jpg)
