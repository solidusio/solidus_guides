...
![New Product Entry Form]({{ site.baseurl }}/assets/img/users/products/new_product_entry_form.jpg)
...
![Product Edit Form]({{ site.baseurl }}/assets/img/users/products/product_edit_form.jpg)
...
* **Shipping Categories** - You will learn about setting up Shipping Categories in the [Shipping Categories]({{ site.baseurl }}/users/shipments/shipping_categories).
* **Tax Category** - You will learn about setting up Tax Categories in the [Taxes Guide]({{ site.baseurl }}/users/configuration/configuring_taxes).
* **Taxons** - Taxons are basically like categories. You will learn more about them in the [Taxonomies Guide]({{ site.baseurl }}/users/configuration/configuring_taxonomies).
...
* **Meta Keywords** - These words are appended to the website's keywords you established in the [Site Settings]({{ site.baseurl }}/users/configuration/configuring_general_settings) and can help improve your site's search engine ratings, bringing you more web traffic. They should be words that are key to your new product.
...
![New Product Image Form]({{ site.baseurl }}/assets/img/users/products/new_image_form.jpg)
...
![New Product Variant]({{ site.baseurl }}/assets/img/users/products/new_variant.jpg)
...
![Variants List]({{ site.baseurl }}/assets/img/users/products/variants_list.jpg)
...
You can learn more about stock locations in the [Stock Locations Guide]({{ site.baseurl }}/users/stock/stock_locations), but for now it's enough to understand that you enter the number of each product variant that you have at each of your individual stock locations.

Let's assume that you have two stock locations - your main New York warehouse and your satellite Detroit warehouse. Refer to the instructions on creating stock locations in the [Stock Locations Guide]({{ site.baseurl }}/users/stock/stock_locations#create-a-new-stock-location) to add your warehouses.

Now, go back to the Tumblers product page, and click the "Stock Management" link.

![Stock Management Page]({{ site.baseurl }}/assets/img/users/products/stock_management.jpg)
...
![Stock Location Info]({{ site.baseurl }}/assets/img/users/products/stock_location_info.jpg)
